    ...
    def trouver_modele(self):
        ...
        while self.lit_une_image:
            ...
            if self.x2_modele == self.WIDTH_PHOTO :
                ...
                res = cv2.matchTemplate(image_gris_roi, self.modele, cv2.TM_CCOEFF_NORMED)
            ...
            if max_val > self.SEUIL_ACCEPTATION:
                ...
                image_avec_objet = cv2.rectangle(image,(xMax,yMax),(xMax + width_modele, yMax + height_modele),(0,255,0),2)
